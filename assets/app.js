        ...
        `
            ...
            $('#location').on('change',function(){
                ...
                if(selectedLocation == 1){
                    var location = products.filter(product => product.location == 'Lower Kabete');
                    ...
                    var location = products.filter(product => product.location == 'Kileleshwa');
                    ...
                    var location = products.filter(product => product.location == 'Limuru Road');
